...
<html lang="en" data-content_root="../../../../../../" >
  ...
  <head>
    ...
    <title>A guide to masked arrays in NumPy &#8212; Jaurice O&#39;Connor | Pricing, Forecasting &amp; Commercial Analytics</title>
...
<link rel="preload" as="script" href="../../../../../../_static/scripts/pydata-sphinx-theme.js?digest=8878045cc6db502f8baf" />
    ...
    <script>var togglebuttonSelector = '.toggle, .admonition.dropdown';</script>
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = '.venv_energy/lib/python3.13/site-packages/numpy/ma/README';</script>
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../../_sources/.venv_energy/lib/python3.13/site-packages/numpy/ma/README.rst" target="_blank"
...
<li><p>01/23/2007 : The package has been moved to the SciPy sandbox, and is regularly updated: please check out your SVN version!</p></li>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./.venv_energy/lib/python3.13/site-packages/numpy/ma"
        },
